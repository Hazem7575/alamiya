...
export function MonthlyCalendar({ events, eventTypes = [] }: MonthlyCalendarProps) {
  console.log('MonthlyCalendar - eventTypes:', eventTypes);
  console.log('MonthlyCalendar - events:', events);
  ...
  for (let day = 1; day <= daysInMonth; day++) {
    ...
    days.push(
      <div
        key={day}
        className={`p-0.5 md:p-1 min-h-[60px] md:min-h-[100px] border-r border-b border-gray-200 relative ${
          isToday 
